# Source: https://github.com/andre-juan/dicke_states_preparation
...
def first_block(n, k, l, draw=False):
    ...
    if n_first != 0:
        ...
        for qubit in qr[:n_first]:
            qc_first_block.id(qubit)
